...
export const OrganizationChart: React.FunctionComponent<IOrganizationChartProps> = (
  ...
  const palette = props.themeVariant?.palette ?? {
    neutralQuaternary: 'transparent',
    neutralLight: 'transparent',
    themeLighter: 'transparent',
    neutralTertiary: 'transparent'
  } as any;
  ...
  const stylesComponent = mergeStyleSets({
    ...
    managerList: {
      ...
      borderLeftWidth: 2,
      borderLeftColor: palette.neutralQuaternary,
    ...
    return (
      <img
        ...
        style={{
          ...
          border: `2px solid ${palette.neutralTertiary}`,
          borderRadius: "50%",
        }}
      />
    );
      ...
      <>
        ...
        >
          <Persona
            ...
            presence={presenceStatus[userInfo.presence?.availability ?? 'PresenceUnknown']}
      ...
      <>
        ...
        >
          <Persona
            ...
            coinSize={40}
            onRenderCoin={_onRenderCoin}
            presence={presenceStatus[managerInfo.presence?.availability ?? 'PresenceUnknown']}
    ...
    (async () => {
      try {
        let {
          ...
          applicationContext.currentUser.loginName ?? applicationContext.currentUser.email ?? "",
                ...
                >
                  ...
                  >
                    <Persona
                      ...
                      onRenderCoin={_onRenderCoin}
                      presence={
                        presenceStatus[state.userProfile?.presence?.availability ?? 'PresenceUnknown']
                      }
